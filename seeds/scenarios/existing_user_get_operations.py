...
class ExistingUserGetOperationsSeedsScenario(SeedsScenario):
    ...
    Создаёт 300 пользователей, открывает кредитный счёт и совершает 5 операций покупки, одну пополнения и одну снятия наличных.
    """
    ...
    def plan(self) -> SeedsPlan:
        ...
        В данном случае создаём 300 пользователей, каждому даём кредитный счёт и 5 операций покупки,
        одну пополнения и одну снятия наличных.
        """
        return SeedsPlan(
            users=SeedUsersPlan(
                count=300,
