...
@users_router.get("/{course_id}", response_model=CourseOut)
...
@users_router.get("", response_model=list[CourseOut])
...
@users_router.post("", response_model=CourseOut, status_code=status.HTTP_201_CREATED)
...
@users_router.put("/{course_id}", response_model=CourseOut)
...
@users_router.delete("/{course_id}", status_code=status.HTTP_204_NO_CONTENT)
