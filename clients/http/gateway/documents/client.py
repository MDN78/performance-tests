...
class DocumentsGatewayHTTPClient(HTTPClient):
    ...
    def get_tariff_document_api(self, account_id: str) -> Response:
        ...
        return self.get(f"{APIRoutes.DOCUMENTS}/tariff-document/{account_id}",
                        extensions=HTTPClientExtensions(route=f"{APIRoutes.DOCUMENTS}/tariff-document"))
    ...
    def get_contract_document_api(self, account_id: str) -> Response:
        ...
        return self.get(f"{APIRoutes.DOCUMENTS}/contract-document/{account_id}",
                        extensions=HTTPClientExtensions(route=f"{APIRoutes.DOCUMENTS}/contract-document"))
...
def build_documents_gateway_locust_http_client(environment: Environment) -> DocumentsGatewayHTTPClient:
    ...
    :return: Экземпляр DocumentsGatewayHTTPClient хуками сбора метрик.
    """
